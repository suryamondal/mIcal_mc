...
#ifndef micalAbsorberParameterisation_H
#define micalAbsorberParameterisation_H 1
...
class micalAbsorberParameterisation : public G4VPVParameterisation
{ 
  public:
  
    micalAbsorberParameterisation(G4int    NoChambers, 
				  G4double startZ, 
				  G4double halfWidthZ, 
				  G4double spacing,
				  G4double polAngle,
				  ...
				  G4double halfY);
    virtual				 
   ~micalAbsorberParameterisation();
   
    void ComputeTransformation (const G4int copyNo,
                                G4VPhysicalVolume* physVol) const;
    
    void ComputeDimensions (G4Trd & activeLayer,const G4int copyNo,
			    const G4VPhysicalVolume* phyVol) const;
